...
cl = LINETCR.LINE()
cl.login(token="EpnFvrzn2U2CRCvok5H0.2PshkH9jZu06gbOeQKJtua.m03FHcWiSeYFaiB3JrKpN6XkoRbPnP1qp7NIP+FxdIc=")
cl.loginResult()

kt = LINETCR.LINE()
kt.login(token="EpiTlIJzvhoB8Qolywc5.PtU14xG9qDZsMoFG8SHeXq.sRgKZeUqcQZo1xokEmB0sXo3+eIXMiY2O/FLoXU6u+s=")
kt.loginResult()

ks = LINETCR.LINE()
ks.login(token="EppbnhMos9Pn5GRXbVqc.yKMMCS8Ql11gcKL6dYbkda.roldJLTDdYDR2ZO6g0Qcm+c4cUW7fxZa6jTzXvCFfKs=")
ks.loginResult()

ki = LINETCR.LINE()
ki.login(token="EpVdZRmy3wmcZjC043R6.hjHmunzx1zM8NcHQsorFLG.q5H6eSHhYTVXximXa748Q5zM674WaHVgVgBgcV8Rq8w=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EpZ1mAMxKRCCOgqcKeh8.i3hnA4/p23TFxB7SF/e5ca.aeCjGnxq6oQJwxRnx+RYY+GR2f9ATz1apaY357lzcww=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EpCtiSsUUEOFdrVWPy8f.bZXO57FcGQJeBrV8gQ0VhW.yAEfmEdyplYNMA7VPe8ejN7b8HuC+ZzYkdvnFZqIaEI=")
kc.loginResult()
