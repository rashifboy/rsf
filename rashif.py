...
kt = LINETCR.LINE()
kt.login(token="Eo1jopPdh3stRXV7KhMf.bZXO57FcGQJeBrV8gQ0VhW.WYuxK6AWLM4WvOCBt7NoaYYbSfv+kzwe6DrDmDJ0QGY=")
kt.loginResult()

ks = LINETCR.LINE()
ks.login(token="EomHk9ZtWfsjW5UtL1I8.5BKwe+Dtvxmo+2btG4hFwa.P29MSvb3iVeyME/e6QbbGLQ2loUuRsJXU+S0XcdNhg0=")
ks.loginResult()

ki = LINETCR.LINE()
ki.login(token="EofmhJpGk9ORysPII4J4.J7W6iljVRU0f/+iEQR9ADa.jEwq+w8TLgifRdEMqXuelmAZgojRZNOHMG7EhYA85yo=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EokI1wOCaZniERXUFPGc.yKMMCS8Ql11gcKL6dYbkda.66kckFxVwOkaxGo8UiVECIKKna9GsWOSfFECECLH+ws=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EoEU5OvOjdxVP0A3gkf5.PtU14xG9qDZsMoFG8SHeXq.1+T1yfhz9prRwf3sqVal0IzWL05crQDw/fEhCV2Dpl4=")
kc.loginResult()
...
helpMessage= """Rashif's private bot v.1
...
wait = {
    ...
    "lang":"JP",
    "comment":"This auto like ny:~>http://line.me/ti/p/mEHpAq1ejt",
    "welmsg":"Selamat datang di group ini jangan lupa cek note semoga selalu betah ☺",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
