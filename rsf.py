...
Use command in group's and with uppercase
∆Self command∆
°Google..
°Sayv..
°Playstore..
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["",cName + " Ngapa Tag, Duit Ga?, ", cName + " Kenapa? pc aja klo penting" + cName + "Knp?", "Ada Perlu apa? jgn tag doang, " + cName + "?","Hmm?, ", "Ciee Nge Add :v, "]
