...
helpmsg ="""✍RashiF's Self Bot✺
౯All command with uppercase ~
[✓]Google..
[✓]Sayv..
[✓]Playstore..
[✓]Instagram..
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["",cName + " Langsung pc saja ga usah ngetag!!"]
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["kickMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["",cName + "Langsung pc saja ga usah ngetag bangsat!!"]
                     ret_ = "[Auto Respond]\n" + random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
            ...
            if msg.contentType == 13:
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to, "%sseconds" % (elapsed_time))
                    ...
                    cl.sendText(msg.to,"%s/Detik" % (elsp))    
...
#==============================================================================#
            ...
            elif msg.text in ["Respontag on","Autorespon:on","Respon on","Respon:on","Tag on"]:
                wait["detectMention"] = True
                cl.sendText(msg.to,"Auto respon tag On")
                
            elif msg.text in ["Respontag off","Autorespon:off","Respon off","Respon:off","Tag off"]:
                wait["detectMention"] = False
                cl.sendText(msg.to,"Auto respon tag Off")
            
            elif msg.text in ["Kicktag on","Autokick:on","Responkick on","Responkick:on","Tag2 on"]:
                wait["kickMention"] = True
                cl.sendText(msg.to,"Auto Kick tag ON")
                
            elif msg.text in ["Kicktag off","Autokick:off","Responkick off","Responkick:off","Tag2 off"]:
                       ...
                       for target in targets:
                            try:
                               ...
                               cl.sendText(msg.to, "Copied.")
                                ...
                                print e
            elif msg.text in ["Mybackup","mybackup","Backup"]:
                try:
...
#================================ PUY SCRIPT STARTED ==============================================#
		...
		for contact in group.members:
            ...
            elif "Cek id " in msg.text:
                msgg = msg.text.replace('Cek id ','')
