# -*- coding: utf-8 -*-
#Bot create by RashiF
#Hargai please karya orang
...
translateMessage ="""✯「 Translate command」✯
...
#--------------------------------------------------------
                ...
                cl.sendMessage(msg)
#--------------------------------------------------------
            elif msg.text in ["Trcmd"]:
                cl.sendText(msg.to,translateMessage)
#---------------------------------------------------------
            elif msg.text in ["Stealcmd"]:
                cl.sendText(msg.to,steal)
#-----------------------------------------------------
            elif msg.text in ["Bancmd"]:
              cl.sendText(msg.to,WhiteList)
#---------------------------------------------------------
          
#---------------------------------------------------------
            elif msg.text in ["Copycmd"]:
              cl.sendText(msg.to,copy)
#--------------------------------------------------------
            elif msg.text in ["Setcmd"]:
...
#--------------------------------------------------------
                ...
                wait["AutoJoin"] = True
                cl.sendText(msg.to,"AutoJoin Active 􀜁")

            elif msg.text in ["Join off","Autojoin:off"]:
                wait["AutoJoin"] = False
                cl.sendText(msg.to,"AutoJoin inActive 􀜁")
#--------------------------------------------------------
...
#---------------------------------------------------------
                ...
                wait["blacklist"] = {}
                cl.sendText(msg.to,"Done 􀜁􀆚Hare")
#--------------------------------------------------------
...
#--------------------------------------------------------
                ...
                try:
                    ...
                    cl.comment(url['result']['posts'][0]['userInfo']['mid'], url['result']['posts'][0]['postInfo']['postId'], "Auto Like by RashiF")
...
#--------------------------------------------------------
                ...
                try:
                    ...
                    cl.sendText(msg.to,"Success backup profile 􀜁~")
                except Exception as e:
                    cl.sendText(msg.to, str(e))
#--------------------------------------------------------
...
#---------------------------------------------------------
                ...
                if wait["autoinvite"] == True:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Auto invite on")
                else:
                ...
                if wait["autoinvite"] == False:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Auto invite off")
                else:
...
#-------------------------------------------------------
                ...
                if wait["autoreject"] == True:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Autoreject on")
                else:
                ...
                if wait["autoreject"] == False:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Autoreject off")
                else:
...
#--------------------------------------------------------
                ...
                cl.sendText(msg.to, "Restarted 􀜁succes")
                restart_program()
                print "@Restart"
#--------------------------------------------------------
