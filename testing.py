...
cl = LINETCR.LINE()
#cl.login(qr=True)
#cl.login(cert='1df6488448108708de8ae97ed3da43ac2fe684ba3aae23a9d9d04ed632a23765')
cl.login(token='EnujRnW9SfDRNF91Ltna.sG9LpQDx2NQ81bWvVW8v2G.i21jLsPc/xTMwke+Amdxfjk6ZQozkXSdsYfti05zh3o=')
cl.loginResult()
...
╚═════════════════════════
"""
tjia="u31ef22df7f538df1d74dc7f756ef1a32"
#----------------------------------------------------------
setMessage ="""
╔═════════════════════════
║              ☆☞ S E T ☜☆
...
admin=["u31ef22df7f538df1d74dc7f756ef1a32"]
...
#--------------------------------------------------------
		...
		if msg.from_ in Creator:
		    ...
		    cl.sendText(msg.to, "Khusus Kris")
#--------------------------------------------------------
...
#--------------------------------------------------------
            elif "@􀐂􀆭􏿿 􀐂『Kris‮『 " in msg.text:
              if wait["Tag"] == True:
                tanya = msg.text.replace("@􀐂􀆭􏿿 􀐂『Kris‮『 ","")
                jawab = ("Jangan Tag Si Kris...","Berisik Jangan Tag Si Kris...,","Sekali lagi nge tag gw sumpahin jomblo seumur hidup!","Dia Lagi Sibuk Jangan Tag Kris","Woii Bicik Jangan Tag Kris Lagi Gua Bilang!!!","Kris Lagi Off...\nKalau Penting PC Aja Kris nya")
